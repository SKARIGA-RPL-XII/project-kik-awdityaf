                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h4 text-gray-900 mb-4">Payment Unfinished</h1>
                                        
                                        <div class="alert alert-warning">
                                            <h6><i class="fas fa-info-circle mr-2"></i>What happened?</h6>
                                            <p class="mb-0">Your payment process was not completed. This could be due to:</p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-2">
                                                <a href="<?= base_url('member/membership_plans'); ?>" class="btn btn-warning btn-block">
