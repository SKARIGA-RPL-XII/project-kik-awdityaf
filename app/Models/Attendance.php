...
class Attendance extends Model
{
    ...
    public static function byMember($memberId, $limit = null)
    {
    ...
    public static function getMonthlyAttendance()
    {
        return self::selectRaw('DATE(date) as date, COUNT(*) as total')
    ...
    public static function getMonthlyAttendanceCount()
    {
        return self::where('date', '>=', Carbon::now()->subDays(30))->count();
    }
    ...
    public static function getRate($memberId, $days = 30)
    {
    ...
    public static function isInGym($memberId)
    {
        return self::where('member_id', $memberId)
    ...
    {
        return self::selectRaw('DAYNAME(date) as day, COUNT(*) as total')
