...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Dashboard -->
            <li
                class="nav-item {{ request()->segment(2) == null || request()->segment(2) == 'index' ? 'active' : '' }}">
            ...
            <!-- Subscriptions -->
            <li class="nav-item {{ request()->segment(2) == 'my_subscriptions' ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('member/my_subscriptions') }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in">
                                ...
                                <a class="dropdown-item" href="{{ url('member/change_password') }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-success" href="{{ url('auth/logout') }}">
                        Logout
                    </a>
                </div>
